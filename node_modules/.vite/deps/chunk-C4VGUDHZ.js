...
function D(t2, e, o = true) {
  ...
  if (t2) {
    ...
    f2.top + u + s4 > lt2.height ? (L = f2.top + g4 - s4, ot = "bottom", L < 0 && (L = g4)) : L = u + f2.top + g4, f2.left + a2 > lt2.width ? N2 = Math.max(0, f2.left + it + p2 - a2) : N2 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N2 + "px" : t2.style.insetInlineStart = N2 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l2 = (i2 = x(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l2 : "");
  }
}
function S(t2, e) {
...
function ce(e, t2 = {}) {
  ...
  for (; i2.length; ) {
    ...
    for (let p2 in m2) {
      let h2 = m2[p2], y3 = ke(h2), x3 = z(p2, a2) ? Q2(u) : Q2(u, ee(p2));
      if (i(y3)) i2.push({ node: y3, path: x3 });
      else {
        let k3 = ne(x3), w3 = Y3(y3, x3, s4, [a2]);
        _e(l2, k3, w3);
        let $3 = x3;
...
var S2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re } = a2, y3 = te || {}, { colorScheme: K3 } = y3, M3 = b3(y3, ["colorScheme"]), N2 = re || {}, { colorScheme: X } = N2, B2 = b3(N2, ["colorScheme"]), x3 = K3 || {}, { dark: G2 } = x3, I2 = b3(x3, ["dark"]), k3 = X || {}, { dark: U3 } = k3, H = b3(k3, ["dark"]), W2 = s(L) ? this._toVariables({ primitive: L }, n) : {}, q2 = s(M3) ? this._toVariables({ semantic: M3 }, n) : {}, Z = s(I2) ? this._toVariables({ light: I2 }, n) : {}, de = s(G2) ? this._toVariables({ dark: G2 }, n) : {}, ue2 = s(B2) ? this._toVariables({ semantic: B2 }, n) : {}, pe = s(H) ? this._toVariables({ light: H }, n) : {}, ge = s(U3) ? this._toVariables({ dark: U3 }, n) : {}, [Le, Me] = [(w3 = W2.declarations) != null ? w3 : "", W2.tokens], [Ae, je] = [($3 = q2.declarations) != null ? $3 : "", q2.tokens || []], [De, ze] = [(j2 = Z.declarations) != null ? j2 : "", Z.tokens || []], [Ke, Xe] = [(V2 = de.declarations) != null ? V2 : "", de.tokens || []], [Be, Ge] = [(D2 = ue2.declarations) != null ? D2 : "", ue2.tokens || []], [Ie, Ue] = [(z3 = pe.declarations) != null ? z3 : "", pe.tokens || []], [He, We] = [(E2 = ge.declarations) != null ? E2 : "", ge.tokens || []];
  ...
  if (s(t2) && r.transform !== "strict") {
    let k3 = e.replace("-directive", ""), m2 = t2, { colorScheme: w3, extend: $3, css: j2 } = m2, V2 = b3(m2, ["colorScheme", "extend", "css"]), u = $3 || {}, { colorScheme: D2 } = u, z3 = b3(u, ["colorScheme"]), p2 = w3 || {}, { dark: E2 } = p2, L = b3(p2, ["dark"]), h2 = D2 || {}, { dark: te } = h2, re = b3(h2, ["dark"]), K3 = s(V2) ? this._toVariables({ [k3]: d2(d2({}, V2), z3) }, r) : {}, M3 = s(L) ? this._toVariables({ [k3]: d2(d2({}, L), re) }, r) : {}, X = s(E2) ? this._toVariables({ [k3]: d2(d2({}, E2), te) }, r) : {}, [B2, G2] = [(y3 = K3.declarations) != null ? y3 : "", K3.tokens || []], [I2, U3] = [(N2 = M3.declarations) != null ? N2 : "", M3.tokens || []], [H, W2] = [(x3 = X.declarations) != null ? x3 : "", X.tokens || []], q2 = this.transformCSS(k3, `${B2}${I2}`, "light", "variable", r, o, a2, n), Z = this.transformCSS(k3, H, "dark", "variable", r, o, a2, n);
    l2 = `${q2}${Z}`, i2 = [.../* @__PURE__ */ new Set([...G2, ...U3, ...W2])], c3 = m(j2, { dt: P });
  }
  ...
  if (s(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c3.reduce((m2, { type: u, selector: p2 }) => (s(p2) && (m2 += p2.includes("[CSS]") ? p2.replace("[CSS]", t2) : this.getSelectorRule(p2, l2, u, t2)), m2), "") : T2(l2 != null ? l2 : ":root", t2);
    }
    if (i2) {
      let c3 = { name: "primeui", order: "primeui" };
      i(i2) && (c3.name = m(i2.name, { name: e, type: s4 })), s(c3.name) && (t2 = T2(`@layer ${c3.name}`, t2), a2 == null || a2.layerNames(c3.name));
    }
    return t2;
  }
  return "";
...
var g3 = { defaults: { variable: { prefix: "p", selector: ":root", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t2 } = e;
  t2 && (this._theme = _2(d2({}, t2), { options: d2(d2({}, this.defaults.options), t2.options) }), this._tokens = S2.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
  ...
  this._theme = _2(d2({}, this.theme), { preset: e }), this._tokens = S2.createTokens(e, this.defaults), this.clearLoadedStyleNames(), R3.emit("preset:change", e), R3.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(e) {
  this._theme = _2(d2({}, this.theme), { options: e }), this.clearLoadedStyleNames(), R3.emit("options:change", e), R3.emit("theme:change", this.theme);
}, getLayerNames() {
  ...
  getStyleSheet: function getStyleSheet() {
    ...
    if (this.css) {
      ...
      var _props = Object.entries(props).reduce(function(acc, _ref2) {
        var _ref3 = _slicedToArray(_ref2, 2), k3 = _ref3[0], v4 = _ref3[1];
        return acc.push("".concat(k3, '="').concat(v4, '"')) && acc;
      }, []).join(" ");
  ...
  getThemeStyleSheet: function getThemeStyleSheet(params) {
    ...
    if (this.style) {
      ...
      var _props = Object.entries(props).reduce(function(acc, _ref4) {
        var _ref5 = _slicedToArray(_ref4, 2), k3 = _ref5[0], v4 = _ref5[1];
        return acc.push("".concat(k3, '="').concat(v4, '"')) && acc;
      }, []).join(" ");
...
//# sourceMappingURL=chunk-C4VGUDHZ.js.map
